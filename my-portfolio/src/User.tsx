...
const ProjectInfo = [
  {
    ...
    image: "vedas.jpeg", // Correct path (directly in public)
  ...
  },
  {
    ...
    image: "weather.jpeg", // Correct path (directly in public)
  ...
  },
  {
    ...
    image: "ecommerce.jpeg", // Correct path (directly in public)
